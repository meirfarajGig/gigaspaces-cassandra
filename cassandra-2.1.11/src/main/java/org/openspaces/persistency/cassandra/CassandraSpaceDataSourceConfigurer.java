...
public class CassandraSpaceDataSourceConfigurer {
     ...
     * java type will be deserialized using {@link org.openspaces.persistency.cassandra.meta.types.dynamic.PropertyValueSerializer#fromByteBuffer(java.nio.ByteBuffer)}

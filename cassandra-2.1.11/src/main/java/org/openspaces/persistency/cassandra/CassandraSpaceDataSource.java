...
public class CassandraSpaceDataSource extends ClusterInfoAwareSpaceDataSource {
    ...
    public CassandraSpaceDataSource(
        ...
        this.cassandraClient = cassandraClient.copyClientWithConnectionPoolSize(
                minimumNumberOfConnections, maximumNumberOfConnections);
        this.cassandraClient.createMetadataColumnFamilyColumnFamilyIfNecessary();

        this.mapper = new DefaultSpaceDocumentColumnFamilyMapper(
                fixedPropertyValueSerializer, dynamicPropertyValueSerializer);
    ...
    public DataIterator<Object> getDataIteratorByIds(DataSourceIdsQuery idsQuery)
    {
        ...
        Map<Object, SpaceDocument> documentsByKeys = cassandraClient.readDocumentsByKeys(mapper, typeName, ids);
    ...
    private Object getByIdImpl(String typeName, Object id) {
        return cassandraClient.readDocmentByKey(mapper, typeName, id);
    }
    
    @Override
    public DataIterator<SpaceTypeDescriptor> initialMetadataLoad() {
        super.initialMetadataLoad();
        Map<String, ColumnFamilyMetadata> columnFamilies = cassandraClient.populateColumnFamiliesMetadata(mapper);
    ...
    public DataIterator<Object> initialDataLoad() {
        ...
        Map<String, ColumnFamilyMetadata> columnFamilies = cassandraClient.getColumnFamiliesMetadata();

...
public class NamedLockProvider {
     ...
     * @return The shared {@link java.util.concurrent.locks.ReentrantLock} matching the provided name.
     * One is created if it doesn't already exist.
     * Note that the returned {@link java.util.concurrent.locks.ReentrantLock} should still be aquired and released by the client
     * calling this method.
     */

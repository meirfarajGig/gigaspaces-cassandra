...
/**
 * Serialized objects will contain a prefix denoting the type of the value and 
 * will be deserialized appropriately based on this prefix. 
 * Default serialization machanizm for non primitive, non common java types
 * is standard object serialization.
 * 
 * {@link Object}/{@link java.math.BigInteger}/{@link java.math.BigDecimal} serialization logic borrowed from hector serializers,

...
/**
 * An interface used by {@link FlattenedPropertiesFilter} to pass the current inspected
...
public interface PropertyContext {
    ...
    /**
     * @return path to this property. For example if the root entry contains a POJO property
